...
| LOCKED | App content hidden; platform credential/biometric gate. | Unlock; no content previews/actions. | Durable preference may persist. Session unlock is in-memory only. Failure to authenticate remains locked. |
