...
- JVM unit tests for compatible, incompatible, and unavailable bridge states, blocked feature mapping, contact-ID not-implemented, and no fallback success. These tests use fakes and do not require native JNA.
