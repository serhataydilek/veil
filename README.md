...
See [`docs/implementation/phase-1a-status.md`](docs/implementation/phase-1a-status.md), [`docs/implementation/phase-1b-status.md`](docs/implementation/phase-1b-status.md), [`docs/implementation/phase-1c-status.md`](docs/implementation/phase-1c-status.md), and [`docs/implementation/phase-1d-status.md`](docs/implementation/phase-1d-status.md) for implemented, blocked, and deferred work.
